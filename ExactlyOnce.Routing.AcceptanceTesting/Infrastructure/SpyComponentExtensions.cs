...
{
    public static IScenarioWithEndpointBehavior<TContext> WithPoisonSpyComponent<TContext>(this IScenarioWithEndpointBehavior<TContext> scenario, Action<TransportExtensions<TestTransport>> transportConfiguration)
