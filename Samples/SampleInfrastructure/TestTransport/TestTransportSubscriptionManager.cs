...
{
    class TestTransportSubscriptionManager : IManageSubscriptions
    {
        public TestTransportSubscriptionManager(string basePath, string endpointName, string localAddress)
        {
